            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route('product_types.update',encryptor('encrypt',$productType->id))}}">
                                 @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control" value="{{ old('name',$productType->name)}}" name="name">
                                            @if($errors->has('name'))
