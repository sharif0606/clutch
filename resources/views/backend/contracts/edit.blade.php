            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route('contracts.update',encryptor('encrypt',$contract->id))}}">
                                 @csrf
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="startdate" class="form-control" value="{{ old('startdate')}}" name="startdate">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="finishdate" class="form-control" value="{{ old('finishdate')}}" name="finishdate">
