            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="post" enctype="multipart/form-data" action="{{route('loads.store')}}">
                                @csrf
                                <div class="row">
                                            ...
                                            <select name="contract_id"         class="form-control" id="contract_id" >
                                                <option value="">Select Contract</option>
                                                    @forelse($contract as $c)
                                                        <option value="{{$c->id}}" @if(old('contract_id')==$c->id) selected @endif>{{$c->contractnumber}}</option>
                                                    @empty
